    ...
    <header class="ScriptHeader">
        <div class="rt-container">
            <div class="col-rt-12" style="float: left;">
                ...
                <div>
                    <?php if ($flag[0] != 0) {
                        echo '<a href="user/atm.php?id=' . $idhref[0] . '">';
                    ...
                    <?php if ($flag[4] != 0) {
                        echo '<a href="user/atm.php?id=' . $idhref[4] . '">';
                    ...
                    <?php if ($flag[1] != 0) {
                        echo '<a href="user/atm.php?id=' . $idhref[1] . '">';
                    ...
                    <?php if ($flag[5] != 0) {
                        echo '<a href="user/atm.php?id=' . $idhref[5] . '">';
                    ...
                    <?php if ($flag[3] != 0) {
                        echo '<a href="user/atm.php?id=' . $idhref[3] . '">';
                    ...
                    <?php if ($flag[2] != 0) {
                        echo '<a href="user/atm.php?id=' . $idhref[2] . '">';
